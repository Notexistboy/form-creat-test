...
<script>
  import cSelect from '@/components/component/c-select'
  ...
  export default {
    ...
    data () {
      return {
        itemList: [
          ...
          {name: '层联选择器', value: "cascader"},
          {name: '可删除选择器', value: 'select'},
          {name: '时间选择器', value: 'DatePicker'},
          {name: '日期选择器', value: 'TimePicker'},
        ],
        rule: [],
        comName: "",
        dialogState: false,
    ...
    methods: {
      ...
      getRule(type,comName){
        debugger
        this.rule.push({
            type:type,title:comName,field:"title",value:"",
        })
        this.comName=""
      },
      showDialog() {
